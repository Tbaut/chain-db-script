...
export type AddUniqueFieldMotionMutationVariables = {
  id: Scalars['ID'];
  uniqueStatus: Scalars['String'];
};


export type AddUniqueFieldMotionMutation = (
  { __typename?: 'Mutation' }
  & { updateMotionStatus?: Maybe<(
    { __typename?: 'MotionStatus' }
    & Pick<MotionStatus, 'uniqueStatus'>
  )> }
);

export type GetOnchainMotionStatusesQueryVariables = {};


export type GetOnchainMotionStatusesQuery = (
  { __typename?: 'Query' }
  & { motions: Array<Maybe<(
    { __typename?: 'Motion' }
...
export type OnchainMotionFragment = (
  ...
  & { motionStatus?: Maybe<Array<(
    { __typename?: 'MotionStatus' }
    & MotionStatusFragment
  )>> }
);

export type MotionStatusFragment = (
  { __typename?: 'MotionStatus' }
  & Pick<MotionStatus, 'id' | 'status'>
);

export type AddUniqueFieldReferendumMutationVariables = {
  id: Scalars['ID'];
  uniqueStatus: Scalars['String'];
};


export type AddUniqueFieldReferendumMutation = (
  { __typename?: 'Mutation' }
  & { updateReferendumStatus?: Maybe<(
    { __typename?: 'ReferendumStatus' }
    & Pick<ReferendumStatus, 'uniqueStatus'>
  )> }
);

export type GetOnchainReferendaStatusesQueryVariables = {};


export type GetOnchainReferendaStatusesQuery = (
  { __typename?: 'Query' }
...
export type RefStatusFragment = (
  { __typename?: 'ReferendumStatus' }
  & Pick<ReferendumStatus, 'id' | 'status'>
);

export type AddUniqueFieldTreasuryMutationVariables = {
  id: Scalars['ID'];
  uniqueStatus: Scalars['String'];
};


export type AddUniqueFieldTreasuryMutation = (
  { __typename?: 'Mutation' }
  & { updateTreasuryStatus?: Maybe<(
    { __typename?: 'TreasuryStatus' }
    & Pick<TreasuryStatus, 'uniqueStatus'>
  )> }
);

export type GetOnchainTreasuryStatusesQueryVariables = {};


export type GetOnchainTreasuryStatusesQuery = (
  { __typename?: 'Query' }
...
export type OnchainTreasuryFragment = (
  { __typename?: 'TreasurySpendProposal' }
  & Pick<TreasurySpendProposal, 'treasuryProposalId'>
  & { treasuryStatus?: Maybe<Array<(
    { __typename?: 'TreasuryStatus' }
    & TreasuryStatusFragment
  )>> }
);

export type TreasuryStatusFragment = (
  { __typename?: 'TreasuryStatus' }
  & Pick<TreasuryStatus, 'id' | 'status'>
);

export type AddUniqueFieldProposalMutationVariables = {
  id: Scalars['ID'];
  uniqueStatus: Scalars['String'];
};


export type AddUniqueFieldProposalMutation = (
  { __typename?: 'Mutation' }
  & { updateProposalStatus?: Maybe<(
    { __typename?: 'ProposalStatus' }
    & Pick<ProposalStatus, 'uniqueStatus'>
  )> }
);

export type GetOnchainProposalStatusesQueryVariables = {};


export type GetOnchainProposalStatusesQuery = (
  { __typename?: 'Query' }
...
export const MotionStatusFragmentDoc = gql`
...
export const OnchainMotionFragmentDoc = gql`
  ...
  motionStatus {
    ...
    ${MotionStatusFragmentDoc}`;
export const RefStatusFragmentDoc = gql`
...
export const OnchainReferendumFragmentDoc = gql`
  ...
  referendumStatus {
    ...
    ${RefStatusFragmentDoc}`;
export const TreasuryStatusFragmentDoc = gql`
    fragment treasuryStatus on TreasuryStatus {
  id
  status
}
    `;
export const OnchainTreasuryFragmentDoc = gql`
...
export const AddUniqueFieldMotionDocument = gql`
    mutation addUniqueFieldMotion($id: ID!, $uniqueStatus: String!) {
  updateMotionStatus(where: {id: $id}, data: {uniqueStatus: $uniqueStatus}) {
    uniqueStatus
  }
}
    `;
export const GetOnchainMotionStatusesDocument = gql`
...
export const AddUniqueFieldReferendumDocument = gql`
    mutation addUniqueFieldReferendum($id: ID!, $uniqueStatus: String!) {
  updateReferendumStatus(where: {id: $id}, data: {uniqueStatus: $uniqueStatus}) {
    uniqueStatus
  }
}
    `;
export const GetOnchainReferendaStatusesDocument = gql`
...
export const AddUniqueFieldTreasuryDocument = gql`
    mutation addUniqueFieldTreasury($id: ID!, $uniqueStatus: String!) {
  updateTreasuryStatus(where: {id: $id}, data: {uniqueStatus: $uniqueStatus}) {
    uniqueStatus
  }
}
    `;
export const GetOnchainTreasuryStatusesDocument = gql`
    query getOnchainTreasuryStatuses {
  treasurySpendProposals {
    ...onchainTreasury
  }
}
    ${OnchainTreasuryFragmentDoc}`;
export const AddUniqueFieldProposalDocument = gql`
    mutation addUniqueFieldProposal($id: ID!, $uniqueStatus: String!) {
  updateProposalStatus(where: {id: $id}, data: {uniqueStatus: $uniqueStatus}) {
    uniqueStatus
  }
}
    `;
export const GetOnchainProposalStatusesDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    addUniqueFieldMotion(variables: AddUniqueFieldMotionMutationVariables): Promise<AddUniqueFieldMotionMutation> {
      return withWrapper(() => client.request<AddUniqueFieldMotionMutation>(print(AddUniqueFieldMotionDocument), variables));
    },
    getOnchainMotionStatuses(variables?: GetOnchainMotionStatusesQueryVariables): Promise<GetOnchainMotionStatusesQuery> {
      return withWrapper(() => client.request<GetOnchainMotionStatusesQuery>(print(GetOnchainMotionStatusesDocument), variables));
    },
    addUniqueFieldReferendum(variables: AddUniqueFieldReferendumMutationVariables): Promise<AddUniqueFieldReferendumMutation> {
      return withWrapper(() => client.request<AddUniqueFieldReferendumMutation>(print(AddUniqueFieldReferendumDocument), variables));
    },
    getOnchainReferendaStatuses(variables?: GetOnchainReferendaStatusesQueryVariables): Promise<GetOnchainReferendaStatusesQuery> {
      return withWrapper(() => client.request<GetOnchainReferendaStatusesQuery>(print(GetOnchainReferendaStatusesDocument), variables));
    },
    addUniqueFieldTreasury(variables: AddUniqueFieldTreasuryMutationVariables): Promise<AddUniqueFieldTreasuryMutation> {
      return withWrapper(() => client.request<AddUniqueFieldTreasuryMutation>(print(AddUniqueFieldTreasuryDocument), variables));
    },
    getOnchainTreasuryStatuses(variables?: GetOnchainTreasuryStatusesQueryVariables): Promise<GetOnchainTreasuryStatusesQuery> {
      return withWrapper(() => client.request<GetOnchainTreasuryStatusesQuery>(print(GetOnchainTreasuryStatusesDocument), variables));
    },
    addUniqueFieldProposal(variables: AddUniqueFieldProposalMutationVariables): Promise<AddUniqueFieldProposalMutation> {
      return withWrapper(() => client.request<AddUniqueFieldProposalMutation>(print(AddUniqueFieldProposalDocument), variables));
    },
    getOnchainProposalStatuses(variables?: GetOnchainProposalStatusesQueryVariables): Promise<GetOnchainProposalStatusesQuery> {
      return withWrapper(() => client.request<GetOnchainProposalStatusesQuery>(print(GetOnchainProposalStatusesDocument), variables));
    }
  };
}